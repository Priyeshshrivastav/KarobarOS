...
export default function SignupPage() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Proceed to onboarding to set up business
  ...
  return (
    <div className="min-h-screen bg-[#090d16] flex flex-col justify-center items-center px-4 py-12 relative overflow-hidden">
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-96 h-96 bg-teal-600/15 blur-[120px] rounded-full pointer-events-none" />
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-white tracking-tight">
            Start with Karobar<span className="text-emerald-400">OS</span>
          </h2>
          <p className="text-xs text-slate-400 mt-1">
            Empower your Indian SMB with autonomous AI
          </p>
        </div>
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="aakash@business.com"
                  required
                  className="w-full pl-9 pr-3.5 py-2.5 rounded-xl bg-slate-900/90 border border-slate-700 text-sm text-white placeholder:text-slate-500 focus:outline-none focus:border-emerald-500 transition-colors"
                />
              </div>
            ...
            >
              {loading ? (
                ...
                <>
                  <span>Create Account &amp; Setup Business</span>
